...
public final class BuildShipmentPrintPlan {
    ...
    /**
     * Builds print tasks for the selected shipment labels.
     *
     * @param shipment prepared shipment labels to print
     * @param selectedLabelIds optional label IDs limiting which pallet labels are included
     * @return ordered shipment print plan
     */
    ...
    /**
     * Carries ordered shipment print tasks across application boundaries.
     *
