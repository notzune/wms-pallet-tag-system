...
public final class ExecuteQueue {
    ...
    /**
     * Creates a Execute Queue instance.
     *
     * @param shipmentPlanner the shipment planner.
     * @param carrierMovePlanner the carrier move planner.
