...
- The largest remaining architecture hotspots are still `LabelGuiFrame` and `OracleDbQueryRepository`. `AdvancedPrintWorkflowService` is improved, but further cleanup should continue extracting by responsibility instead of broad rewrites.
