...
- The largest remaining architecture hotspots are still `LabelGuiFrame`, `AdvancedPrintWorkflowService`, and `OracleDbQueryRepository`. Any deeper cleanup should keep targeting those classes with extraction-by-responsibility rather than broad rewrites.
