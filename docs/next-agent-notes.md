...
- Installer helpers now exist for packaged installs: `install-wms-installer.ps1` / `.bat` for logged install and same-version replacement, plus `uninstall-wms-tags.ps1` / `.bat` for direct uninstall.
