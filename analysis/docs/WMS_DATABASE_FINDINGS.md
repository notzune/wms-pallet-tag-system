...
Successfully connected to Oracle WMS database and completed full schema discovery. The WMS data resides in the **WMSP
schema** with **719 tables** and contains all necessary information for pallet tag label generation.
