...
/**
 * Creates Oracle JDBC data sources from WMS 2.0 runtime settings.
 */
public final class OracleDataSourceFactory {
    ...
    /**
     * Builds a Hikari configuration from Oracle runtime settings.
     *
     * @param settings Oracle connection and pool settings
     * @return configured Hikari connection pool settings
     */
    ...
    /**
     * Creates a Hikari-backed Oracle data source.
     *
     * @param settings Oracle connection and pool settings
