...
/**
 * Provides oracle shipment repository behavior for WMS 2.0 workflows.
 */
public final class OracleShipmentRepository implements ShipmentRepository {
    ...
    /**
     * Creates an Oracle-backed shipment repository.
     *
    ...
    /**
     * Finds by shipment id.
     *
     * @param shipmentId the shipment id.
     * @return prepared shipment labels, when present
     */
    @Override
