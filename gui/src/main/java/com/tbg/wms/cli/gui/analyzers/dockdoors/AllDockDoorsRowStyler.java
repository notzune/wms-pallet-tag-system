...
public final class AllDockDoorsRowStyler implements AnalyzerRowStyler<AllDockDoorsRow> {

    @Override
    public AnalyzerRowStyle styleFor(AllDockDoorsRow row) {
        ...
        if ("AIRBAG".equalsIgnoreCase(row.airbagFlag())) {
            return AnalyzerRowStyle.of(AnalyzerColorPalette.WALMART_BLUE, AnalyzerColorPalette.DEFAULT_FOREGROUND);
        }
