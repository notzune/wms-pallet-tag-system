    ...
    public static List<GuiHelpSupport.HelpSection> railLabels() {
        return List.of(
                ...
                section("Rail Card Checks",
                        "Consist markers count resolved line items by family, for example D-4 C-3 CC-2.",
                        "Short codes 20557 and 20558 are Costco Club: CC in the consist marker and CLUB in the family callout.",
                        "CAN, DOM, KEV, and CLUB totals still come from WMS footprint pallet math.",
                        "Unresolved short codes appear in Diagnostics and print as MISSING counts on affected cards."),
