...
final class OracleShipmentQuerySupport {
    ...
    Shipment loadShipment(String shipmentId) throws SQLException {
        ...
        List<Lpn> lpns = fetchLpnsWithLineItems(shipmentId);
        return new Shipment(
    ...
    private List<Lpn> fetchLpnsWithLineItems(String shipmentId) throws SQLException {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            java.util.Map<String, List<LineItem>> lineItemsByLpn = fetchLineItemsByLpn(conn, shipmentId);
    ...
    private java.util.Map<String, List<LineItem>> fetchLineItemsByLpn(Connection conn, String shipmentId) throws SQLException {
        java.util.Map<String, List<LineItem>> lineItemsByLpn = new HashMap<>();
