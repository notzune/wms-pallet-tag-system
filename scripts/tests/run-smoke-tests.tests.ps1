...
Assert-True -Condition ($runnerContent.Contains("smoke\target\generated-smoke\smoke-manifest.json")) -Message "Smoke runner should prefer the generated 2.0 smoke manifest"
